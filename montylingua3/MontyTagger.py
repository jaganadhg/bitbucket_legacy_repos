...
import MontyCommonsense
import MontyLemmatiser

class MontyTagger(object):
    ...
    def __init__(self,trace_p=0,MontyLemmatiser_handle=None):
        ...
        self.theLRP=MontyLexicalRuleParser.MontyLexicalRuleParser(\
		self.theLexicon)
        self.theCRP=MontyContextualRuleParser.MontyContextualRuleParser()
        self.theMontyCommonsense=MontyCommonsense.MontyCommonsense(\
		self.theMontyLemmatiser,self)
    ...
    def tag_tokenized(self,text,all_pos_p=0,commonsense_p=1):
        ...
        for cps in chmod_dict:
            ...
            _montylingua.append({'word':cps,'pos':chmods,'all_pos':\
			the_tokenizer_dict})
