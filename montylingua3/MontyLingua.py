__version__ = "2.1"
import MontyTokenizer, MontyTagger, MontyLemmatiser, MontyREChunker, \
MontyExtractor, MontyNLGenerator

class MontyLingua(object):
    ...
    def __init__(self,trace_p=0):
        ...
        self.theMontyTagger = MontyTagger.MontyTagger(trace_p,\
		self.theMontyLemmatiser)
	...
	s_dtnum=('',1),o1_dtnum=('',1),o2_dtnum=('',1),o3_dtnum=('',1)):
        ...
        valid sentence types: declarative, imperative, (can|may|would|should|could),
        ...
        valid numbers = 1,2,3
      	"""
        return self.theMontyNLGenerator.generate_sentence(vsoo,sentence_type=\
		sentence_type,tense=tense,s_dtnum=s_dtnum,o1_dtnum=o1_dtnum,o2_dtnum=\
		o2_dtnum,o3_dtnum=o3_dtnum)
    ...
    def extract_info(self,chunked_text):
        ...
        verb_arg_structures: ['will/MD go/VB quickly/RB','the/DT dog/NN',
		'to/IN the/DT cats/NNS']
        verb_arg_structures_concise: ['("go" "dog" "to cat")]
    	"""
    	return self.theMontyExtractor.extract_info(chunked_text,\
		self.theMontyLemmatiser.lemmatise_tagged_sentence)
...
if __name__ == "__main__":
    ...
    try:
        while 1:
            ...
            predicates_list = map(lambda a:m.parse_pred_arg(a),\
			reduce(lambda y,z:y+z,map(lambda x:x['verb_arg_structures_concise'\
			],extractions)))
