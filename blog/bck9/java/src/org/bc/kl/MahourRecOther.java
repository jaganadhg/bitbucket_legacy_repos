...
public class MahourRecOther {
	
	public static Recommender setRecommener() throws Exception{
		DataModel dm = new FileDataModel(new File(
		"/home/jaganadhg/Desktop/bck9/pci.csv"));
		UserSimilarity us = new TanimotoCoefficientSimilarity(dm);
